...
def parse_opts_ft():
    ...
    parser.add_argument('--normal_class', default='frames', type=str, help='normal_class')
    ...
    parser.add_argument('--psuedo_anomaly_contribution', default='0.001', type=float, help='the contribution of pseudo anomalies loss being added compared with the loss of Go reconstructed images in total_normal_loss')
    parser.add_argument('--epoch', default=10, type=int, help='Epoch for training')
    ...
    parser.add_argument('--frame_size', default=64, type=int, help='one side size of the square patch to be extracted from each frame')
    parser.add_argument('--low_epoch', default=2, type=int, help='low epoch i.e. Gold for phase two')
    parser.add_argument('--high_epoch', default=5, type=int, help='high epoch i.e. Gn for phase two')
